...
| Application integration | `billing-app/src/test/java/.../api/` | <!--count:integration-->160<!--/count--> | Spring context + MockMvc | HTTP contract, status codes, error shape, rendered templates |
| API automation | `qa-api-tests` | <!--count:api-->129<!--/count--> | Running application over HTTP | The published contract as a client sees it |
...
**Total automated: <!--count:total-->600<!--/count--> tests**, of which 596 run on every pull request

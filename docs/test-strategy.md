...
| Application integration | `billing-app/src/test/java/.../api/` | <!--count:integration-->150<!--/count--> | Spring context + MockMvc | HTTP contract, status codes, error shape, rendered templates |
...
**Total automated: <!--count:total-->590<!--/count--> tests**, of which 586 run on every pull request

...
| Application integration | `billing-app/src/test/java/.../api/` | <!--count:integration-->125<!--/count--> | Spring context + MockMvc | HTTP contract, status codes, error shape, rendered templates |
...
**Total automated: <!--count:total-->524<!--/count--> tests**, of which 520 run on every pull request

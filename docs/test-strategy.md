...
|---|---|---|---|---|
| Domain and service unit | `billing-app/src/test/java/.../domain/`, `/service/`, `/config/` | <!--count:unit-->175<!--/count--> | Nothing — plain objects | Billing rules, allocation arithmetic, the ledger, message bundles |
| Application integration | `billing-app/src/test/java/.../api/` | <!--count:integration-->112<!--/count--> | Spring context + MockMvc | HTTP contract, status codes, error shape, rendered templates |
...
**Total automated: <!--count:total-->510<!--/count--> tests**, of which 506 run on every pull request

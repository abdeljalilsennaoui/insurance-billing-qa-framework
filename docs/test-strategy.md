...
| Application integration | `billing-app/src/test/java/.../api/` | <!--count:integration-->116<!--/count--> | Spring context + MockMvc | HTTP contract, status codes, error shape, rendered templates |
...
**Total automated: <!--count:total-->490<!--/count--> tests**, of which 486 run on every pull request

...
/**
 * Runs the API-level scenarios.
 *
 * <p>Split from the UI runner by tag so the two layers can run, and fail, independently. A single
 * runner over both would mean a browser problem and a contract problem arrive as the same red result.
 */
@Test
@CucumberOptions(
...
public class ApiScenariosIT extends AbstractTestNGCucumberTests {}

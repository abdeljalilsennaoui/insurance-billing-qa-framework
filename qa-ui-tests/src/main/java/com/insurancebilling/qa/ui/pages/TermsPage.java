...
/**
 * A policy term: its header figures, and the three panels behind them.
 *
 * <p>The panels are tabs with a URL each rather than JavaScript, so {@link #openTab} navigates and waits
 * for a new document exactly as any other link does. That is also why a test can open one directly

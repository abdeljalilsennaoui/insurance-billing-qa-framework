...
![Tests](https://img.shields.io/badge/tests-490%20passing-success)
...
| | |
|---|---|
| **Automated tests** | **<!--count:total-->490<!--/count-->**, all passing · 486 run on every pull request |
...
| Application integration (API + web layer) | <!--count:integration-->116<!--/count--> | JUnit 5 + MockMvc | yes |
...
| **Total** | **<!--count:total-->490<!--/count-->** | | **486** |
| Performance | 1 plan | JMeter | no — run manually, see [perf](perf/README.md) |

486 of the 490 run on every pull request across five CI jobs, with a sixth that runs no tests and

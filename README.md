...
![Tests](https://img.shields.io/badge/tests-510%20passing-success)
...
| | |
|---|---|
| **Automated tests** | **<!--count:total-->510<!--/count-->**, all passing · 506 run on every pull request |
...
|---|---:|---|---|
| Domain and service unit | <!--count:unit-->175<!--/count--> | JUnit 5 | yes |
| Application integration (API + web layer) | <!--count:integration-->112<!--/count--> | JUnit 5 + MockMvc | yes |
...
| **Total** | **<!--count:total-->510<!--/count-->** | | **506** |
| Performance | 1 plan | JMeter | no — run manually, see [perf](perf/README.md) |

506 of the 510 run on every pull request across five CI jobs, with a sixth that runs no tests and
